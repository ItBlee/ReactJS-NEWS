                ...
                <div className="container">
                    <div className="row m-rl--1">
                        <div className="col-md-6 p-rl-1 p-b-2">
                            <div className="bg-img1 size-a-3 how1 pos-relative" style={{ backgroundImage: 'url(images/entertaiment-01.jpg)' }}>
                        ...
                        <div className="col-md-6 p-rl-1">
                            <div className="row m-rl--1">
                                <div className="col-sm-6 p-rl-1 p-b-2">
                                    <div className="bg-img1 size-a-14 how1 pos-relative" style={{ backgroundImage: 'url(images/entertaiment-02.jpg)' }}>
                                        <a href="blog-detail-01.html" className="dis-block how1-child1 trans-03" />
                                        <div className="flex-col-e-s s-full p-rl-25 p-tb-20">
                                            <a href="#" className="dis-block how1-child2 f1-s-2 cl0 bo-all-1 bocl0 hov-btn1 trans-03 p-rl-5 p-t-2">
                                                Game
                                ...
                                <div className="col-sm-6 p-rl-1 p-b-2">
                                    <div className="bg-img1 size-a-14 how1 pos-relative" style={{ backgroundImage: 'url(images/entertaiment-03.jpg)' }}>
                                        <a href="blog-detail-01.html" className="dis-block how1-child1 trans-03" />
                                        <div className="flex-col-e-s s-full p-rl-25 p-tb-20">
                                            <a href="#" className="dis-block how1-child2 f1-s-2 cl0 bo-all-1 bocl0 hov-btn1 trans-03 p-rl-5 p-t-2">
                                                Music
                                ...
                                <div className="col-sm-6 p-rl-1 p-b-2">
                                    <div className="bg-img1 size-a-14 how1 pos-relative" style={{ backgroundImage: 'url(images/entertaiment-04.jpg)' }}>
                                        <a href="blog-detail-01.html" className="dis-block how1-child1 trans-03" />
                                        <div className="flex-col-e-s s-full p-rl-25 p-tb-20">
                                            <a href="#" className="dis-block how1-child2 f1-s-2 cl0 bo-all-1 bocl0 hov-btn1 trans-03 p-rl-5 p-t-2">
                                                Game
                                ...
                                <div className="col-sm-6 p-rl-1 p-b-2">
                                    <div className="bg-img1 size-a-14 how1 pos-relative" style={{ backgroundImage: 'url(images/entertaiment-05.jpg)' }}>
                                        <a href="blog-detail-01.html" className="dis-block how1-child1 trans-03" />
                                        <div className="flex-col-e-s s-full p-rl-25 p-tb-20">
                                            <a href="#" className="dis-block how1-child2 f1-s-2 cl0 bo-all-1 bocl0 hov-btn1 trans-03 p-rl-5 p-t-2">
                                                Music
